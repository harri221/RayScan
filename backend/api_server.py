...
import os
model_path = os.path.join(os.path.dirname(__file__), '..', 'RF_Classifier_Ali_Method.pkl')
if not os.path.exists(model_path):
    model_path = 'RF_Classifier_Ali_Method.pkl'  # Try local directory for deployment
